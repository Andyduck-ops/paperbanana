	...
	return []SystemProviderPreset{
		...
		},
		{
			...
			DefaultModels: []ModelInfo{
				...
				{ID: "grok-4.1-thinking", Name: "Grok 4.1 Thinking", Enabled: true},
				{ID: "grok-4.20-beta", Name: "Grok 4.20 Beta", Enabled: true},
				{ID: "grok-imagine-1.0", Name: "Grok Imagine 1.0", SupportsVision: true, Enabled: true},
				{ID: "grok-imagine-1.0-edit", Name: "Grok Imagine 1.0 Edit", SupportsVision: true, Enabled: true},
			},
			SupportsVision: true,
		},
		{
